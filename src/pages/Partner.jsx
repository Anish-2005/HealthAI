  ...
  return (
    ...
    >
      ...
      <div className="relative w-full overflow-x-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-0 right-0 w-72 h-72 sm:w-96 sm:h-96 translate-x-1/4 translate-y-1/4 rounded-full bg-green-200 opacity-15 blur-2xl dark:bg-emerald-800 dark:opacity-10 z-0"
        ...
        <section className="relative z-10 flex-1 py-24 sm:py-32 px-4 sm:px-6 md:px-8 flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          >
            ...
            >
              Interested in collaborating with us? Let's join forces to build a
              more accessible, intelligent healthcare ecosystem.
            </p>

            <a
              href="mailto:contact@healthai.com"
              className={`inline-block px-6 py-4 rounded-lg font-semibold text-white text-base sm:text-lg shadow-lg transition-all ${
                isDark
